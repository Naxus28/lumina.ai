	...
	return (
		<Dialog>
			<DialogTrigger asChild>
				<Button variant="outline">View Cover Letter Examples</Button>
			</DialogTrigger>
			<DialogContent className="sm:max-w-[80%] max-h-[80vh] overflow-y-auto">
				<DialogHeader>
					<DialogTitle>Cover Letter Examples</DialogTitle>
					<DialogDescription>
						Browse through different cover letter examples to get inspiration for your own.
					</DialogDescription>
				</DialogHeader>

				<div className="mt-4">
					<h3 className="text-lg font-semibold mb-2">{selectedExample.title}</h3>
