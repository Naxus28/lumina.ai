...
const steps = [
	{
		...
		description:
			'Provide your academic background, research, and teaching experiences through our user-friendly interface.',
	},
	{
		icon: MonitorCog,
		title: '2. AI Generates Documents',
		description:
			'Our AI crafts tailored CVs, cover letters, research statements, and teaching philosophies based on your input.',
	},
	{
		icon: Edit,
