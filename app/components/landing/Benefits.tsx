...
// 		<p className="text-xl text-gray-900 mb-8">As an academic, your brilliance should shine through your research and teaching, not your ability to craft application materials. You've invested years contributing to your field, and your focus should remain there.</p>
// 		<p className="text-xl text-gray-900 mb-8">Lumina is your AI assistant in the academic job search process. We understand the balancing act of research projects, teaching responsibilities, and applying to multiple positions. Our solution transforms your accomplishments into compelling application materials, so you can concentrate on what truly matters.</p>
